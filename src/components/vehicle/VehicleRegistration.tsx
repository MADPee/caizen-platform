...
const VehicleRegistration: React.FC<VehicleRegistrationProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const maskedRegistration = createMaskedIdentifier(
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                {showSensitiveData.registration ? (
                  <EyeOff size={16} />
                ) : (
                  <Eye size={16} />
                )}
        ...
        <div className="bg-blue-900 bg-opacity-20 rounded-lg p-4 border border-blue-600">
          ...
          <div className="text-xs text-gray-300 space-y-2">
            <p>
              ✅ <strong>Maskerade identifierare:</strong> Reg.nr och VIN visas
              som ABC*** / WBA***********1234
            </p>
            <p>
              ✅ <strong>Krypterad lagring:</strong> Känslig data krypteras med
              militärgrad säkerhet
            </p>
            <p>
              ✅ <strong>GDPR-kompatibel:</strong> Du kan exportera eller radera
              din data när som helst
            </p>
            <p>
              ✅ <strong>Audit logging:</strong> All åtkomst till fordonsdata
              loggas säkert
            </p>
          </div>
          ...
          <div className="mt-4 flex items-start">
            ...
            <label htmlFor="privacy-consent" className="text-xs text-gray-300">
              ...
              . Känsliga identifierare (reg.nr/VIN) lagras krypterat och visas
              alltid maskerat.
            </label>
          </div>
        </div>
        ...
        {!validation.general.valid && (
          <div className="bg-red-900 bg-opacity-20 rounded-lg p-4 border border-red-600">
            ...
            <ul className="text-xs text-red-300 space-y-1">
              ...
              {!privacyAgreed && <li>• Acceptera behandling av fordonsdata</li>}
            </ul>
          </div>
        )}
      ...
      <div className="mt-6 text-xs text-gray-400 space-y-1">
        <p>
          <strong>Tips:</strong> VIN-numret hittar du vanligtvis på
          instrumentbrädan nära vindrutan eller i dörrkarmen.
        </p>
        <p>
          <strong>Säkerhet:</strong> All fordonsdata krypteras och dina
          identifierare maskeras automatiskt.
        </p>
        <p>
          <strong>Verifiering:</strong> Vi använder VIN för att automatiskt
          hämta korrekt fordonsinformation.
        </p>
      </div>
    </div>
  );
