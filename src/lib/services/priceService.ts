...
const SEED_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    category: "motor_oil",
    description:
      "Biltemas egna helsyntetiska motorolja med ACEA A3/B4. 10-liters dunk — bäst literpris. Budget-vänligt alternativ.",
    specifications: {
      Viskositet: "5W-40",
      Typ: "Helsyntetisk",
      ACEA: "A3/B3, A3/B4",
      Artikelnummer: "36-1919",
      "Biltema Art.nr": "2000051919",
      "High Mileage": "Nej",
    },
    compatibleVehicles: GENERIC_COMPAT,
    prices: [
      makePrice("bt-biltema-10l", "biltema-5w40-10l", "biltema", 599, "10"),
    ],
    lowestPrice: 599,
    highestPrice: 599,
    averagePrice: 599,
  ...
  },
  {
    ...
    category: "motor_oil",
    description:
      "Biltemas egna helsyntetiska motorolja med ACEA A3/B4. 4-liters dunk.",
    specifications: {
      Viskositet: "5W-40",
      Typ: "Helsyntetisk",
      ACEA: "A3/B3, A3/B4",
      Artikelnummer: "36-1918",
      "Biltema Art.nr": "2000051918",
      "High Mileage": "Nej",
    },
    compatibleVehicles: GENERIC_COMPAT,
    prices: [
      makePrice("bt-biltema-4l", "biltema-5w40-4l", "biltema", 299, "4"),
    ],
    lowestPrice: 299,
    highestPrice: 299,
    averagePrice: 299,
  ...
  },
  {
    ...
    category: "motor_oil",
    description:
      "Biltemas helsyntetiska motorolja, 1-liters förpackning. ACEA C3, A3/B3, A3/B4.",
    specifications: {
      Viskositet: "5W-40",
      Typ: "Helsyntetisk",
      ACEA: "C3, A3/B3, A3/B4",
      Artikelnummer: "36-1987",
      "Biltema Art.nr": "2000051987",
      "High Mileage": "Nej",
    },
    compatibleVehicles: GENERIC_COMPAT,
    prices: [
      makePrice("bt-biltema-1l", "biltema-5w40-1l", "biltema", 100, "1"),
    ],
    lowestPrice: 100,
    highestPrice: 100,
    averagePrice: 100,
